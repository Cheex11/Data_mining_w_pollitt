dim ColumnHeaders
ColumnHeaders = Array("Travel","Exercise","BeiberRespect","Confidence","Spirituality","Extroversion","DogPerson","Drinker","Sleeper","SamHater")
...
dim ColumnModifiers
ColumnModifiers = Array("No","Light","Average","Moderate","Maximum")
...
Do Until objExcel.Cells(data_row-1,data_column).Value = ""
	...
	Do Until objExcel.Cells(data_row,x) = ""
		...
		Select Case objExcel.Cells(data_row,x)
		  Case 1
		    add_column = 0
		  Case 2
		    add_column = 1
		...
		for i = fill_column to fill_column + 5
